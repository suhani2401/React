  ...
  return (
    <div className="max-w-[600px] my-0 mx-auto text-center">
      ...
      <form action="" onSubmit={handleSubmit}>
        ...
        {!isPending && <button className="bg-[#f1356d] text-[#fff] border-0 p-[8px] rounded-[8px] cursor-pointer">
          Add Blog
        </button>}
         {isPending && <button className="bg-[#f1356d] text-[#fff] border-0 p-[8px] rounded-[8px] cursor-pointer" disabled>
          Adding Blog...
        </button>}
        <p>{title}</p>
        <p>{body}</p>
